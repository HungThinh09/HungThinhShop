        ...
        <div class="formAdd row justify-content-center ">
            ...
            <div class="col-md-3 col-lg-3 col-12">    
                ...
                <div id="wapper" class="form-group">
                    Hiển thị : &emsp; <input type="checkbox" value="1" name="status" {{$product->status==1?"checked":""}} checked class='switch-toggle'>
                    </td>
                </div>     
                
                <div id="wapper" class="form-group">
                    Còn hàng :  &emsp; <input type="checkbox" value="1" name="active" {{$product->status==1?"checked":""}} checked class='switch-toggle'>
                    </td>
                </div>    
            </div>
        </div>
        <button type="submit" class="btn btn-primary btn-lg" style="margin: 20px">Sửa danh mục</button>
    </form>
@endsection
@section('jquery')
